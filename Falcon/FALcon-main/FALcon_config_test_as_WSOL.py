...
class FALcon_config(object):
    ...
    if dataset == 'cub':
        ...
        in_num_channels         = 3
        full_res_img_size       = (256, 256) #(height, width) as used in transforms.Resize
        gt_bbox_dir             = '/home/20204130/imagenet-subset/ILSVRC/Annotations/CLS-LOC/train'
        wsol_method             = 'PSOL'
    ...
    switch_location_th          = 0.1
    objectness_based_nms_th     = 0.4
    confidence_based_nms_th     = 0.4
