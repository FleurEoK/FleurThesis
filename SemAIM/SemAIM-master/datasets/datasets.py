...
# from refile import smart_open as open
...
class ImageListFolder(datasets.ImageFolder):
    def __init__(self, root, transform=None, target_transform=None,
        ...
        self.samples = []
        ann = open(ann_file)
        # for loop that reads each line of the txt file and creates a tuple with the path and the target and appends it to the samples list
